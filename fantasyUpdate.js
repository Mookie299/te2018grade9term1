...
let fantasyNameCreator = { 
  ...
  street: '199 & Jerome',
  fantasyName: 'Rhea',
  getNewFirstName: function(str){
    let firstName = str.substring(0, 2);
    return newStr;
  }
...
getNewLastName: function(str){
  let lastName1 = str.charAt(str.length-1)
  let lastName2 = str.charAt(str.length-2)
  return newStr;
}
